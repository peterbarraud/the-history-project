  ...
  class RestfulApp {
    function run(){
      ...
      if (is_callable($callback)){
        ...
        echo json_encode("<div style='background-color:#9baedd;color:red;font-size:30px;padding:20px;border:5px solid red;'>Error: We don't have any such RestFUL API. Please try something else or let us know.</div>");
      }      
    }
